...
const PROJECTS = [
  ...
  // ── ПРОЕКТ 0 ── FINCORP ──────────────────────────────────
  {
    ...
    bannerColor: '#7F77DD',
    lightBanner: true,
    cardImg: 'assets/FinCorp banner.jpg',
    images: ['assets/FinCorp.jpg'],
  ...
  {
    id: 11,
    title: { ru: 'Chempionat', en: 'Chempionat' },
    cardImg: 'assets/Chempionat banner.jpg',
    images: ['assets/Chempionat.jpg'],
...
function openProject(id) {
  ...
  if (p.fullImage) {
    ...
    navEl.classList.toggle("first-project", p.id === 6 || p.id === 10 || p.id === 14);
    document.querySelector("footer")?.classList.toggle("first-project", p.id === 6 || p.id === 10 || p.id === 14);
    return;
  }
